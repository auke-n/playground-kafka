...
- The demo UI renders a stage from the same API response that confirms Kafka broker delivery, while the observer consumer independently verifies the record without duplicate timeline entries.
