...
- The demo UI renders a stage immediately after Kafka broker delivery acknowledgment, while the observer consumer independently verifies the record without duplicate timeline entries.
